<?= $navContent; ?>
  <form class="form form--add-lot container <?= $form_error_class; ?>" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form__item <?php if ($errors['category_id']): ?>form__item--invalid<?php endif; ?>">
        ...
        <select id="category" name="newLot[category_id]" >
            ...
            foreach($itemList as $itemNum => $item) {
                ?>
                <option <?php if (($newLot['category_id'] == $item['id'])): ?>selected<?php endif; ?> value="<?= $item['id']; ?>"><?= $item['name']; ?></option>'
                <?php
            }
            ?>
        </select>
    ...
    <div class="form__item form__item--file <?php if ($errors['lot_image']): ?>form__item--invalid<?php endif; ?>">
    ...
    <div class="form__container-three">
      <div class="form__item form__item--small <?php if ($errors['initial_price']): ?>form__item--invalid<?php endif; ?>">
      ...
      <div class="form__item form__item--small <?php if ($errors['bet_increment']): ?>form__item--invalid<?php endif; ?>">
      ...
      <div class="form__item <?php if ($errors['close_date']): ?>form__item--invalid<?php endif; ?>">
